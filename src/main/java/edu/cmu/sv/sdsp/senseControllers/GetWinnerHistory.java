 ...
 */
public class GetWinnerHistory extends AsyncTask<String, String, String> {
	...
	// "http://localhost:8080/sensor/smartSense/currentWin";
	...
	protected String doInBackground(String... arguments) {
		...
		try {
			...
			Log.e("Test", "Exception GWIN" + e.getMessage());
		}
			...
			try {
				...
				if (conn.getResponseCode() != 200) {
					...
					Log.e("Test","Invalid Response GETWIN" + conn.getResponseMessage());
				}
